...
class Sudaderas extends StatefulWidget {
  const Sudaderas({super.key});

  @override
  _SudaderasState createState() => _SudaderasState();
}

class _SudaderasState extends State<Sudaderas> {
  @override
        ...
        children: [
          ...
          Table(
            children: [
              TableRow(
                children: [
                  _buildProductTile('imagenes/sudadera1.png', 'Sudadera Clásica', 'M', 1),
                  _buildProductTile('imagenes/sudadera2.png', 'Sudadera con Capucha', 'L', 2),
                ],
              ),
              TableRow(
                children: [
                  _buildProductTile('imagenes/sudadera1.png', 'Sudadera Oversize', 'XL', 3),
                  _buildProductTile('imagenes/sudadera1.png', 'Sudadera Deportiva', 'S', 4),
                ],
              ),
            ],
          ),
  ...
  void _showConfirmationDialog(BuildContext context, String imagePath,
      String title1, String talla, int id) {
    showDialog(
      context: context,
          ...
          child: Column(
            ...
            children: [
              ...
              TextFormField(
                ...
                validator: (value) =>
                    value == null || value.isEmpty ? 'Por favor ingresa la talla' : null,
