...
class _PerfilScreenState extends State<PerfilScreen> {
  String? userEmail = 'usuario@example.com'; // Puedes cambiarlo por uno temporal
  ...
  Widget _buildProfileInfo() {
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          _buildProfileDetail('Número de teléfono:', userPhoneNumber ?? 'No disponible'),
          const SizedBox(height: 10),
          _buildProfileDetail('Correo electrónico:', userEmail ?? 'No disponible'),
        ],
      ),
    );
  }
